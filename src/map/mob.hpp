...
enum MOBID {
	...
	MOBID_G_RAFFLESIA		= 1790,
	MOBID_G_ICEICLE			= 1789,
	MOBID_G_ICE_TITAN		= 1788,
	MOBID_G_DROSERA			= 1781,
	MOBID_G_ISILLA			= 1772,
	MOBID_G_STAPO			= 1784,
	MOBID_G_MOROCC			= 1916,
	MOBID_G_ROWEEN			= 1782,
	MOBID_G_ECHIO			= 1787,
	MOBID_G_CHONCHON		= 1011,
	MOBID_G_RAWREL			= 1657,
	MOBID_G_NAGA			= 1993,
	MOBID_G_LUCIOLA_VESPA	= 1994,
	MOBID_G_B_YGNIZEM		= 1658,
	MOBID_G_ELDER_WILOW		= 1033,
	MOBID_G_TREASURE_BOX1	= 1324,
	MOBID_G_TREASURE_BOX2	= 1325,
	MOBID_G_TREASURE_BOX3	= 1326,
	MOBID_G_TREASURE_BOX4	= 1327,
	MOBID_G_TREASURE_BOX5	= 1328,
	MOBID_G_TREASURE_BOX6	= 1329,
	MOBID_G_GRYPHON			= 1447,
	MOBID_G_DARK_FRAME		= 1448,
	MOBID_G_MUTANT_DRAGON	= 1449,
	MOBID_G_PARASITE		= 1500,
	MOBID_G_GIBBET			= 1503,
	MOBID_G_DULLAHAN		= 1504,
	MOBID_G_LOLI_RURI		= 1505,
	MOBID_G_DISGUISE		= 1506,
	MOBID_G_BLOODY_MURDERER	= 1507,
	MOBID_G_QUVE			= 1508,
	MOBID_G_LUDE			= 1509,
	MOBID_G_ALICE			= 1521,
	MOBID_G_BACSOJIN		= 1518,
	MOBID_G_CHUNG_E			= 1519,
	MOBID_G_BOILED_RICE		= 1520,
