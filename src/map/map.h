...
#define MAX_VENDING 15
#define MOBID_EMPERIUM 1288
#define MAX_ITEM_LEVEL 99
...
enum _sp {
	 ...
	 * 2045-?
	 *-------------------------------*/
	SP_RACE, SP_LIMITBREAK, SP_ELEDAMAGE, SP_SCDURATION, SP_SCDAMAGE, SP_NOSINGLEMAGIC, SP_NOAREAMAGIC,
	SP_SCRESIST, SP_AREASKILL, SP_SCEXCHANGE, SP_HPATKRATIO, SP_SKILLTIME, SP_AVOIDTRAP, SP_NOCONSUME,
	SP_SKILLGAINSP, SP_MOVECAST, SP_SPATKRATIO, SP_HEALATTACK, SP_CLONEAID, SP_FULLDODGE, SP_LASTSTAND,
	SP_CRITICALDODGE, SP_HPDRAINRATIO, SP_SPDRAINRATIO, SP_MDEFATKRATIO_RC, SP_MDEFATKRATIO_ELE,
	SP_RETAINBUFF, SP_COMPARE, SP_MAXDAMAGE, SP_MINDAMAGE, SP_SONGMOVE, SP_CRITATKMISS, SP_EMOTICON,
	SP_PAYBACK, SP_IGNOREGTB, SP_MATK, SP_MAGICDAMAGERETURN2, SP_COPYCAT, SP_INTIMACY, SP_OVERWEIGHT
};
...
struct map_data {
	...
	struct map_flag {
		...
		unsigned noparty : 1;
		unsigned noleftparty : 1;
		unsigned ctf: 1;
		unsigned presuna: 1;
		unsigned prekonoha: 1;
		unsigned prenevoa: 1;
		unsigned prenuvem: 1;
		unsigned torneio1: 1;
		unsigned torneio2: 1;
...
extern char mob_friendly_db[32];
